  ...
  async execute(interaction) {
    if (interaction.isButton() && interaction.customId === 'panel_backup') {
      ...
      const embed = new EmbedBuilder()
        .setColor('#2b2d31')
        .setTitle(`${emojis._add_emoji} Sistema de Backup`)
        .addFields(
      ...
      const row1 = new ActionRowBuilder().addComponents(
        ...
        new ButtonBuilder().setCustomId('backup_voltar').setLabel('Voltar').setStyle(ButtonStyle.Secondary).setEmoji(emojis._back_emoji)
      );
    ...
    if (interaction.isButton() && interaction.customId === 'backup_mensagem') {
      ...
      const embed = new EmbedBuilder()
        .setColor('#2b2d31')
        .setTitle(`${emojis._mail_emoji} Mensagem de Backup`)
